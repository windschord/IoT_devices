...
/*********************************************************************
SH1106 Adaptation by wonho-maker
Original source: https://github.com/wonho-maker/Adafruit_SH1106
...
/*********************************************************************
RP2350 (Raspberry Pi Pico 2) Compatibility Modifications
- Added conditional compilation for AVR-specific headers
- Replaced port manipulation with digitalWrite for RP2040/RP2350
- Updated SPI configuration for RP2350 compatibility
- Made TWBR register access AVR-specific

Modified for GPS NTP Server project (2024)
*********************************************************************/
...
void Adafruit_SH1106::begin(uint8_t vccstate, uint8_t i2caddr, bool reset) {
  ...
  if (sid != -1){
    ...
    // RP2040/RP2350 specific port handling
    // Use direct GPIO functions instead of port manipulation
#else
...
#elif defined(ARDUINO_ARCH_RP2040) || defined(ARDUINO_RASPBERRY_PI_PICO) || defined(ARDUINO_RASPBERRY_PI_PICO2)
      SPI.setClockDivider(2); // RP2040/RP2350: Use simple divider
#else
...
#if defined(ARDUINO_ARCH_RP2040) || defined(ARDUINO_RASPBERRY_PI_PICO) || defined(ARDUINO_RASPBERRY_PI_PICO2)
    // RP2040/RP2350: Use digitalWrite for software SPI
